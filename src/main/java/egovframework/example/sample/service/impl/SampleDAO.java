...
public class SampleDAO extends EgovAbstractDAO {
	...
	public List<?> selectMyList(String name) {
		return list("sampleDAO.selectMyList", name);
	}

	public List<?> selectMynumber(int count) {
		return list("sampleDAO.selectMynumber", count);
	}
